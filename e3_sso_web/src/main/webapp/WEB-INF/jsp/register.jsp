    ...
    <ul class="individualUserBg">
        <form id="regForm_mod" name="regForm_mod" method="post">
            ...
            <li class="regMb30">
            	...
            	<input id="regName" name="username" class="regInput" type="text"
                       onkeyup="mail_div(event);" onfocus="showtip('regName','userMamErr',8);"
                       onblur="ckmem();" autocomplete="off" maxlength="80"/>
				<em></em>
            </span>
            ...
            <li>
            	...
            	<input id="pwd" name="password" class="regInput" autocomplete="off" type="password"
                       onfocus="showPwdtip('password','passwordErr',2);" onkeyup="ckpwd(0,1);"
                       onblur="ckpwd(0,0);"/>
            	<em></em>
            </span>
            ...
            <li class="regMb30">
                ...
                <span class="regM defaultBorder">
            	<input id="pwdRepeat" name="password2" autocomplete="off" class="regInput"
                       type="password" onfocus="showtip('password2','password2Err',3);"
                       onblur="ckpwd2();"/>
            	<em></em>
            </span>
            ...
            <li class="regMb30">
                ...
                <span class="regM defaultBorder">
            	<input id="phone" name="phone" autocomplete="off" class="regInput" type="text"
                       maxlength="11" onfocus="showtip('phone','phoneErr',1);"
                       onblur="$('#phoneErr').html('')"/>
            	<em></em>
            </span>
